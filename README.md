...
| **Text-to-Speech** | Speech synthesis (TTS) via [`@qvac/tts-ggml`](https://github.com/tetherto/qvac/tree/main/packages/tts-ggml) — Chatterbox, Supertonic, Parler, CosyVoice3, and Audio8. See [Choosing a model](packages/tts-ggml/README.md#choosing-a-model). |
