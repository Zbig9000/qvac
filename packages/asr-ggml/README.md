...
- [`examples/parakeet-transcribe.js`](examples/parakeet-transcribe.js) — CTC, TDT, Unified, EOU, or Sortformer transcription (`npm run example:parakeet`)
- [`examples/parakeet-unified-transcribe.js`](examples/parakeet-unified-transcribe.js) — batch transcription with `parakeet-unified-en-0.6b`
