...
| Engine | GGUF files | Notes |
|--------|-----------|-------|
| Chatterbox Turbo (English) | `chatterbox-t3-turbo.gguf`, `chatterbox-s3gen.gguf` | Voice cloning |
| Chatterbox multilingual | `chatterbox-t3-mtl.gguf`, `chatterbox-s3gen-mtl.gguf` | `en/es/fr/de/pt/it/zh/ja/ko/...` |
| Supertonic (English) | `supertonic.gguf` | 44.1 kHz, voice baked in |
| Supertonic multilingual | `supertonic2.gguf` | `en/ko/es/pt/fr` |
